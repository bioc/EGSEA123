...
author: 
  ...
  - name: Matthew E. Ritchie
    affiliation: The Walter and Eliza Hall Institute of Medical Research, 1G Royal Parade, Parkville, Victoria 3052, Melbourne, Australia; Department of Medical Biology and School of Mathematics and Statistics, The University of Melbourne, Parkville, Victoria 3010, Melbourne, Australia
...
**Package**: `r packageVersion("EGSEA123")`

![](EGSEA.png){width=133px}
...
The code below loads the preprocessed count matrix from Law *et al.* (2016), performs TMM normalisation [@RobinsonOshlack:GenomeBiol:2010] on the raw counts, and calculates voom weights for use in comparisons of gene expression between Basal and LP, Basal and ML, and LP and ML populations. 
...
![Summary plots (directional (left) and ](summary_kegg_LPvsML-dir.png)![ranking (right)) of the significance of all gene sets in the KEGG collection for the LP vs ML contrast.](summary_kegg_LPvsML-rank.png)
...
![Summary plots (directional (left) and ](summary_c2_LPvsML-dir.png)![filtered directional (right)) of the significance of selected gene sets in the c2 collection for the LP vs ML contrast. The x-axis in each plot is the `med.rank`. A cut-off of 300 was used to select significant gene sets in the filtered plot.](summary_sig_c2_LPvsML-dir.png)
...
![Summary plots (directional (left) and ](summary_kegg_1vs2-dir.png)![ranking (right)) of the significance of all gene sets in the KEGG collection for the comparison of the contrasts: Basal vs LP and Basal vs ML.](summary_kegg_1vs2-rank.png)
...
Code to perform this analysis can be found in the **EGSEA123** workflow package available from Bioconductor (<https://bioconductor.org/packages/EGSEA123>).
